...
export type ProfileSummary = { public_id: string; name: string; account_alias: string; execution_mode: string; strategy_name: string; strategy_version: string; strategy_template_id?: string; enabled: boolean; decision_provider?: string; allowed_instruments?: string[]; risk?: ProfileRisk };
